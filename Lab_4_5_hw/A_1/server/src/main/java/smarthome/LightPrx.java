...
public interface LightPrx extends SchedulableDevicePrx
{
    default void setStatus(LightStatus settings)
        throws InvalidInput
    {
        setStatus(settings, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void setStatus(LightStatus settings, java.util.Map<String, String> context)
        throws InvalidInput
    {
        try
        {
            _iceI_setStatusAsync(settings, context, true).waitForResponseOrUserEx();
        }
    ...
    default java.util.concurrent.CompletableFuture<Void> setStatusAsync(LightStatus settings)
    {
        return _iceI_setStatusAsync(settings, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> setStatusAsync(LightStatus settings, java.util.Map<String, String> context)
    {
        return _iceI_setStatusAsync(settings, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_setStatusAsync(LightStatus iceP_settings, java.util.Map<String, String> context, boolean sync)
    {
        ...
        f.invoke(true, context, null, ostr -> {
                     LightStatus.ice_write(ostr, iceP_settings);
                 }, null);
        return f;
    }
