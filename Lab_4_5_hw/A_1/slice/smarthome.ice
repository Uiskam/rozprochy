...
module smarthome
{
  ...
  {
    idempotent void setStatus(LightStatus settings) throws InvalidInput;
  ...
  {
      void setPattern(Pattern pattern) throws InvalidInput;
      Pattern getPattern();
  };
  ...
  interface Fridge
  {
    ...
    void addGroceriesItem(GroceriesItem GroceriesList) throws InvalidInput;
    idempotent GroceriesList getGroceries();
    void removeGroceriesItem(string name);
  };
